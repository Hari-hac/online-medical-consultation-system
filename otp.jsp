					...
					<div class="col-lg-6">
						...
						<div class="panel panel-skin">
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>User Second Verification Page !</h3>
									</div>
                                   <%
                                   String otp=(String)session.getAttribute("otp");
                                   String uname=(String)session.getAttribute("name");
                                   System.out.println("old otp:"+otp+" username.."+uname);
                                   %>
									<div class="panel-body">
                                                                                <form action="otpaction.jsp" class="lead">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Enter Your OTP </label>
												<input type="hidden" name="otp"  value="<%=otp%>" class="form-control input-md">
												<input type="hidden" name="name"  value="<%=uname%>" class="form-control input-md">
												<input type="text" name="uotp" class="form-control input-md">
												</div>
											</div>											
                                                                                </div>
