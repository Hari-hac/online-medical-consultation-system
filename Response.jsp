        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li><a href="Response.jsp">View Report & Update</a></li>
				<li><a href="report.jsp">Response </a></li>
    ...
    <section id="intro" class="intro">
			...
			<div class="container">
             ...
             <table align="center">          
                       <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from report where dname='"+name+"' && status='Waiting' ");
        ...
        <div> 
                ...
                <tr><td><img src="product/<%=product%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            ...
                            <td style="color: darkgreen"><h6><a href="view.jsp?pid=<%=pid%>&&id=<%=rs.getString("id")%>">Give Prescription</a></h6></td>
                </tr> <%}%>   </table> 
  </form><br><br><br><br>			
