					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>Submit Our Report to Specialist</h3>
									</div>
                                                    <div class="panel-body">
                                                                                                    ...
                                                                                                    %>
                                                                                           <form action="Submitrep" class="lead"  method='post' enctype="multipart/form-data">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Doctor Name</label>
													<input type="text" name="dname" value="<%=doc%>" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Specialist</label>
													<input type="type" name="spe" value="<%=spe%>" class="form-control input-md">
												</div>
											</div>
                                                                                        <div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Patient Name</label>
													<input type="text" name="uname" value=<%=uname%> id="last_name" class="form-control input-md">
												</div>
											</div>
                                                                                        <div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="file" name="file" class="form-control input-md">
                                                                                                ...
                                                                                                <div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Lap Type</label>
													<select name="type" style="width: 200px; font-size: 16px;">
                                                                                                            <option>Hemoglobin</option>
                                                                                                            <option>Urine Analysis  <img src=""></option>
                                                                                                            <option>Tumor  <img src=""></option>
                                                                                                            <option>Blood  <img src=""></option>
                                                                                                            <option>BP  <img src=""></option>
                                                                                                        </select>
												</div>
											</div>
										</div>
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="cost" value="200" class="form-control input-md">
												</div>
											</div>
										</div>
