        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li><a href="Report1.jsp">Doctors Report</a></li>
				<li><a href="Pres.jsp">Prescription</a></li>
				<li><a href="Risk.jsp">Risk Stage</a></li>
    ...
    <section id="intro" class="intro">
		<div class="intro-content">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                                    <h2 class="h-ultra" style="font-family: cursive; color:black">Give Rating</h2><br>		
         ...
         String id=request.getParameter("id");
                        ...
                        PreparedStatement query=con.prepareStatement("select * from report where id='"+id+"' && level='Normal' ");
     ...
     <form action="feed.jsp">                     
         ...
         <table align="center"><br><br>
                        <tr align="center"><td>D-Name </td><td><input type="text" name="pname" value="<%=pname%>" readonly=""></td></tr>
                        <tr align="center"><td>Specialist</td><td><input type="text" name="pno" value="<%=des%>" readonly=""></td></tr>
                        <tr align="center"><td>Rating</td><td>
                               <select name ="rank" style="border-radius: 8px; height: 45px; width: 285px;" required>
                            ...
                            </td></tr><tr><td align="center" colspan="2"><button type="submit">Rating</button></td></tr>
                        </table>
     <%}%></form>
