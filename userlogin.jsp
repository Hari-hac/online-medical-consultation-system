					...
					<div class="col-lg-6">
						...
						<div class="panel panel-skin">
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>User Login Page !</h3>
									</div>
									<div class="panel-body">
									<form action="UserLoginAction.jsp" class="lead">
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="password" name="pass" class="form-control input-md">
                                                                                ...
                                                                                <br><br>
                                                                                <h6  align="center"><button><a href="userregister.jsp"  style="font-family: cursive;">Register Here ! </a></button></h6>
									</form>
								</div>
							</div>		 					
