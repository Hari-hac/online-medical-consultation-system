    ...
    <section id="intro" class="intro">
		<div class="intro-content">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                                    <h2 class="h-ultra" style="font-family: cursive; color:black">View Our Report Status</h2><br>		
             <table align="center">          
                       <tr><th>Product</th>
                           <th>ID</th>
                            <th>D-Name</th>
         ...
         <%            String name=session.getAttribute("name").toString();
                        ...
                        PreparedStatement query=con.prepareStatement("select * from report where uname='"+name+"' && level='Normal' ");
        ...
        <div> 
                <tr><td><img src="product/<%=product%>" alt="" style="width: 90px; height: 90px; border-radius: 50px;"></td>
                            <td style="color: darkblue"><%=pid%></td>        
                            <td><%=pname%></td>  
                            <td><%=des%></td>
                            <td><%=uname%></td>    
                            <td style="color: red;"><%=mail%></td>                  
                            <td><%=comname%></td> 
                            <td style="color: darkblue"><%=uemail%></td>              
                            <td style="color: darkgreen"><%=ac%></td>              
                            <td style="color: darkgreen"><%=rs.getString("pre")%></td>
                            <td style="color: darkgreen"><h6><a href="view3.jsp?pid=<%=pid%>&&id=<%=rs.getString("id")%>">Rating</a></h6></td>
