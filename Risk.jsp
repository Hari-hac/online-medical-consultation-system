    ...
    <section id="intro" class="intro">
		<div class="intro-content">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                                    <h2 class="h-ultra" style="font-family: cursive; color:black">View Our Report Risk Status</h2><br>		
             <table align="center">          
                  <style>
                    tr,td
                    {
         ...
         <%            String name=session.getAttribute("name").toString();
                        ...
                        PreparedStatement query=con.prepareStatement("select * from report where uname='"+name+"' && level='Risk' ");
