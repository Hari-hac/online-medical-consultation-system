							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>Choose Our Specialist</h3>
                                                    ...
                                                    <div class="panel-body">
                                                                                <form action="spe1.jsp" class="lead">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
												<label>Specialist Name</label>
												<select name="spe" class="form-control input-md">
                                                                                                    <option>Choose Specialist</option>
                                                                                                    <%
                                                                                                    Class.forName("com.mysql.jdbc.Driver");
                                                                                                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/lab","root","root");
                                                                                                    PreparedStatement ps=con.prepareStatement("select * From dreg group by special ");
                                                                                                    System.out.println(ps);
                                                                                                    ResultSet rs=ps.executeQuery();
                                                                                                    while(rs.next()){
                                                                                                    %>
                                                                                                    <option><%=rs.getString("special")%></option><%}%>
                                                                                                </select>  
												</div>
											</div>											
                                                                                </div>
